...
pycubrid는 [sqlalchemy-cubrid](https://github.com/cubrid-labs/sqlalchemy-cubrid) — CUBRID용 SQLAlchemy 2.0 방언의 드라이버로 동작합니다:
...
- [sqlalchemy-cubrid](https://github.com/cubrid-labs/sqlalchemy-cubrid) — CUBRID용 SQLAlchemy 2.0 방언
- [cubrid-python-cookbook](https://github.com/cubrid-labs/cubrid-python-cookbook) — CUBRID를 위한 프로덕션용 Python 예제
